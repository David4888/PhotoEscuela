...
<body class="bg-black h-screen antialiased leading-none font-sans">
    <div class="px-5">
        ...
        <div class="mt-4 mr-4 space-x-4 sm:mt-6 sm:mr-6 sm:space-x-6 flex flex-row justify-between">
            <div>
                <a href="{{ route('fotos') }}"
                    class="no-underline hover:underline text-sm font-bold text-white uppercase">{{ __('Fotos') }}</a>
    ...
    <style>
        *{
        ...
        .foto {
            ...
            height: 300px;
            height: 50vh;
            /*Para que ocupe el 100% del dispositivo*/
            ...
            /* cubre lo que queda de la pantalla de ancho, contain de alto*/
        ...
        /*primer elemento de la clase coche*/
        .foto:nth-child(1n) {
            height: 100vh;
        }

        .foto:nth-child(2n) {
            background-image: url('https://images.unsplash.com/photo-1624075250557-9e020cecaaf6?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1171&q=80');
        }
    ...
    <div class="foto"><h2>La página de fotos donde subir tus mejores imágenes</h2></div>
    <div class="foto"><h2>Regístrate y comparte tus mejores imágenes con cientos de usuarios</h2></div>
